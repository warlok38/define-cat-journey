...
export const ROOM_TRANSITION_PLAYER_INTO_HALL_DURATION = 500;
export const ROOM_TRANSITION_PLAYER_INTO_HALL_DELAY = 150;
export const ROOM_TRANSITION_PLAYER_INTO_NEXT_ROOM_DURATION = 500;
export const ROOM_TRANSITION_PLAYER_INTO_NEXT_ROOM_DELAY = 510;
export const ROOM_TRANSITION_CAMERA_ANIMATION_DURATION = 750;
export const ROOM_TRANSITION_CAMERA_ANIMATION_DELAY = 250;
...
export const HERO_SPEED_FAST = 300;
